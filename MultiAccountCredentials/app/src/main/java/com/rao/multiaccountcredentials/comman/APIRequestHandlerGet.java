...
public class APIRequestHandlerGet {
    ...
    public APIRequestHandlerGet(Context context, String url, Map<String, String> params, String authToken, RelativeLayout progressBar) {
