...
public class CheckFace extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    private static final String UPLOAD_URL ="https://31c3-2402-8100-315f-2f3e-ac0a-16b3-8194-9f33.ngrok-free.app/api/recognize-face/"; // Replace with your API endpoint
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraPreview = findViewById(R.id.camera_preview_check);
//        imageCountText = findViewById(R.id.image_count_text);
//        progressBar = findViewById(R.id.progress_bar);
        captureButton = findViewById(R.id.capture_button_check);
    ...
    private void initializeSurfaceView() {
        ...
        holder.addCallback(CheckFace.this);
    ...
    private void uploadImage(File imageFile) {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                runOnUiThread(() -> Toast.makeText(CheckFace.this, "Image uploaded successfully!", Toast.LENGTH_SHORT).show());
            } else {
                Log.e("Upload", "Server returned non-OK code: " + responseCode);
                runOnUiThread(() -> Toast.makeText(CheckFace.this, "Failed to upload image.", Toast.LENGTH_SHORT).show());
            }
            ...
            runOnUiThread(() -> Toast.makeText(CheckFace.this, "Upload failed: " + e.getMessage(), Toast.LENGTH_SHORT).show());
        } finally {
            if (connection != null) {
